...
# Infrastructure as Code for EKS, VPC, IAM, and Secrets Manager
...
module "eks" {
  ...
  # Node groups configuration (Fixed for Capacity & Free Tier stability)
  node_groups = {
    general = {
    ...
    spot = {
      ...
      min_size       = 1
      max_size       = 2
      capacity_type  = "ON_DEMAND" # Fixed: Switched from SPOT to ON_DEMAND for availability
      disk_size      = 20
